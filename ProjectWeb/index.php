...
<body>
    <nav class = "navbar navbar-dark bg-dark text-center">
        <span class = "navbar-brand mb-0 text-center h1">Budget Calculator</span>
    </nav>
    <br><br><br>
    <div class = "container">
        <div class = "row">
            ...
            <div class = "col-md-8">
                <h2 class = "text-center">Total Exepnsese : <?php echo $total;?></h2>
                <hr>
                <br><br>
                ...
                <?php $result = mysqli_query($con , "SELECT * from budget");?>
